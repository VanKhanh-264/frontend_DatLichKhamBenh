                    ...
                    <div className='container' style={{maxWidth: '86%'}}>
                        <div className='row'>
                            ...
                            <div className='col-3'>
                                ...
                                >
                                    {roles && roles.length > 0 && positions.map((item,index) => {
                            ...
                            <div className='col-12 w-50 my-3'>
                                <button className={this.state.action === CRUD_ACTIONS.EDIT ? 'btn btn-warning mt-3 px-3 h-75' : 'btn btn-primary mt-3 px-3 h-75'}
