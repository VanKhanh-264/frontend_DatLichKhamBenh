                ...
                <div className="home-header-container">
                    <div className="home-header-content">
                        <div className="left-content">
                            ...
                            <div className="header-logo" onClick={() => this.backToHome()}></div>
                        </div>
                        ...
                        <div className="right-content">
                            <div className='support'>
                                <i className="fa fa-question-circle" aria-hidden="true"></i><FormattedMessage id="homeheader.support" /></div>
                        ...
                        <div className='content-down d-flex align-items-end justify-content-center' >
                            <div className='options'>
                                <div className='option-child'>
                                    <div className='icon-child'><i className="far fa-hospital" aria-hidden="true"></i></div>
                                ...
                                <div className='option-child'>
                                    <div className='icon-child'><i className="fas fa-procedures" aria-hidden="true"></i></div>
                                    <div className='text-child'><FormattedMessage id='banner.option3' /></div>
                                </div>
                                <div className='option-child'>
                                    <div className='icon-child'><i className="fa fa-flask" aria-hidden="true"></i></div>
                                    <div className='text-child'><FormattedMessage id='banner.option4' /></div>
                                </div>
                                <div className='option-child'>
                                    <div className='icon-child'><i className="fas fa-user-md" aria-hidden="true"></i></div>
                                    <div className='text-child'><FormattedMessage id='banner.option5' /></div>
                                </div>
                                <div className='option-child'>
                                    <div className='icon-child'><i className="fa fa-hospital" aria-hidden="true"></i></div>
